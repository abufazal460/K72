...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      image2:
        "http://k72.ca/images/caseStudies/SollioAg/thumbnailimage_SollioAg.jpg?w=1280&h=960&s=3085861fabc3a15e7f8f8a01c07afa4f",
    },
    {
      image1:
  ...
  return (
    <div className="p-2">
      <div className="pt-[40vh]">
        <h2 className="font-[font2] uppercase text-[14vw] text-black">Projets</h2>
      </div>
      <div  className="lol xl:-mt-20">
        {projects.map((elem, idx) => {
          return (
            <div key={idx} className="hero w-full h-[600.1px] flex md:flex-row flex-col  gap-2 mb-2">
